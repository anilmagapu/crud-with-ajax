# RailsAdmin config file. Generated on May 12, 2015 10:39
...
#     private def can_admin? 
#     raise CanCan::AccessDenied unless current_user.role!=""
# end end end 
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Sample', 'Admin']
  ...
  # config.included_models = ['Article', 'Product', 'User']
